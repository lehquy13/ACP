...
namespace ACP.Infrastructure.BackgroundJobs.Configs;
    ...
    public void Configure(QuartzOptions options)
    {
        ...
        options
            ...
            .AddTrigger(trigger => trigger.ForJob(jobKey)
                ...
                .WithCronSchedule("0 59 23 * * ?")); // You can use https://www.freeformatter.com/cron-expression-generator-quartz.html to generate cron expression
